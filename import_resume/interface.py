...
class ResumeImporter(ABC):
    ...
    def validate_data(self, df: pd.DataFrame) -> tuple[List[Resume], List[ResumeValidationError]]:
        """
    ...
    def apply_source_specific_transforms(self, row_dict: Dict[str, Any]) -> Dict[str, Any]:
        """
